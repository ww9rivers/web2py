#!/bin/sh
##	$Id: deploy.sh,v 1.1 2014/05/21 19:49:43 weiwang Exp $;
##
##	Shell script to deploy files to NetApps.

DIRS="contrib"
BINFILES="	admin.py	dal.py		html.py		messageboxhandler.py	rewrite.py	shell.py
		thread_local_singleton.py	winservice.py	cache.py		debug.py	http.py
		myregex.py	rocket.py	sqlhtml.py	tools.py		xmlrpc.py	cfs.py
		decoder.py	import_all.py	newcron.py	sanitizer.py		sql.py		utf8.py
		compileapp.py	fileutils.py	__init__.py	portalocker.py		scheduler.py	storage.py
		utils.py	contenttype.py	globals.py	languages.py		reserved_sql_keywords.py
		serializers.py	streamer.py	validators.py	custom_import.py	highlight.py	main.py
		recfile.py	restricted.py	settings.py	template.py	widget.py"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py'}/${SUBDIR:-gluon}
