...
DIRS=""
BINFILES="__init__.py	markmin.html       markmin.pdf        markmin2html.py
	markmin2latex.py   markmin2pdf.py"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/gluon/contrib'}/${SUBDIR:-markmin}
