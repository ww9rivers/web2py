...
DIRS=""
BINFILES="__init__.py		basic_auth.py		browserid_account.py
	cas_auth.py		dropbox_account.py	email_auth.py
	extended_login_form.py	gae_google_account.py	ldap_auth.py
	linkedin_account.py	loginradius_account.py	loginza.py
	motp_auth.py		oauth10a_account.py	oauth20_account.py
	oneall_account.py	openid_auth.py		pam_auth.py
	rpx_account.py
	saml2_auth.py
	x509_auth.py"
ETCFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/gluon/contrib'}/${SUBDIR:-login_methods}
