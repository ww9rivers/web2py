...
##
##	Shell script to deploy files.

DIRS=""
BINFILES="delete_icon.png	dim_bullet.gif
	embossed.png                           files_toggle.png
	folder.png                             folder_locked.png
	folder_sm.png                          glyphicons-halflings-white.png
	glyphicons-halflings.png               header_bg.png
	header_shadow.png                      help.png
	menu.png                               menu_responsive.png
	questions.png                          red_bullet.gif
	save_icon.png                          search.png
	section_bullet.png                     sidebar_background.jpg
	sidebar_bullet.gif                     sidebar_bullet.png
	small_button.png                       small_special_button.png
	spinner.gif                            start.png
	test_icon.png                          ticket_section.png"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/static'}/${SUBDIR:-images}
