...
DIRS=""
BINFILES="ajax_editor.js            analytics.min.js          autoscroll.js
	bootstrap.min.js          calendar.js               dd_belatedpng.js
	hogan-2.0.0.js            jquery-listfilter.js      jquery.flot.js
	jquery.flot.resize.js     jquery.hotkeys.js         jquery.js
	jquery.timeentry.js       jqueryMultiSelect.js      modernizr.custom.js
	share.js                  typeahead.min.js          web2py.js
	web2py_bootstrap.js"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/static'}/${SUBDIR:-js}
