...
DIRS=""
BINFILES="	bootstrap-responsive.min.css
	bootstrap.min.css                      bootstrap_adapters.css
	bootstrap_essentials.css               calendar.css
	jqueryMultiSelect.css                  styles.css
	typeahead.js-bootstrap.css             web2py-codemirror.css
	web2py.css                             web2py_bootstrap.css
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/static'}/${SUBDIR:-css}
