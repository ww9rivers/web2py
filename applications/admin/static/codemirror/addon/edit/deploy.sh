...
DIRS=""
BINFILES="closebrackets.js          closetag.js
	continuelist.js           matchbrackets.js
	trailingspace.js"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/static/codemirror/addon'}/${SUBDIR:-edit}
