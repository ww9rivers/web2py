...
DIRS=""
BINFILES="colorize.js               runmode-standalone.js     runmode.js
runmode.node.js"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/static/codemirror/addon'}/${SUBDIR:-runmode}
