...
DIRS=""
BINFILES="	html-hint.js	javascript-hint.js
	python-hint.js		show-hint.css		show-hint.js
	xml-hint.js"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/static/codemirror/addon'}/${SUBDIR:-hint}
