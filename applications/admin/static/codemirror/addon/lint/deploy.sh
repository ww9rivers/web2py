...
DIRS=""
BINFILES="coffeescript-lint.js      javascript-lint.js        json-lint.js
lint.css                  lint.js"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/static/codemirror/addon'}/${SUBDIR:-lint}
