...
DIRS=""
BINFILES="brace-fold.js
comment-fold.js    foldcode.js        foldgutter.css     foldgutter.js
indent-fold.js     xml-fold.js"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/static/codemirror/addon'}/${SUBDIR:-fold}
