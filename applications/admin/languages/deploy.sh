...
DIRS=""
BINFILES="	af.py     cs.py    es.py     he.py     ja.py     pl.py         plural-uk.py  ro.py  sr-cr.py  uk.py     zh-tw.py
	bg-bg.py  de-de.py    de.py        fr-fr.py  it-it.py  nl.py     plural-en.py  pt-br.py      ru.py  sr-lt.py  zh-cn.py
	bg.py     default.py  es-es.py     fr.py     it.py     pl-pl.py  plural-ru.py  pt.py         sl.py  tr.py     zh.py"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin'}/${SUBDIR:-languages}
