...
DIRS=""
BINFILES="	appadmin.py		debug.py	default.py
		gae.py			mercurial.py	openshift.py
		plugin_jqmobile.py	shell.py	toolbar.py
		webservices.py		wizard.py"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin'}/${SUBDIR:-controllers}
