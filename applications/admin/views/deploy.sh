...
DIRS="	debug		default.mobile	default		gae
	mercurial	openshift	plugin_jqmobile	shell
	toolbar		wizard"
BINFILES="appadmin.html generic.html layout.html web2py_ajax.html"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin'}/${SUBDIR:-views}
