...
DIRS=""
BINFILES="about.html		  amy_ajax.html             change_password.html
	delete.html               delete_plugin.html        design.html
	downgrade_web2py.html     edit.html                 edit_language.html
	errors.html               git_pull.html             git_push.html
	index.html                layout.html               peek.html
	plugin.html               resolve.html              site.html
	test.html                 ticket.html               ticket.load
	uninstall.html            upgrade_web2py.html       user.html"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications/admin/views'}/${SUBDIR:-default.mobile}
