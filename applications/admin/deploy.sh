...
DIRS="		controllers	static		views		cron
		languages	models		private"
BINFILES="	__init__.py	 settings.cfg"
ETCFILES=""
LIBFILES=""
...
export EMPFBIN=${EMPFBIN:-'/opt/miops/web2py/applications'}/${SUBDIR:-admin}
